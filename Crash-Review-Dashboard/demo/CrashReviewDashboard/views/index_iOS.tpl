...
<!-- <div class="col-form-label">Select Country you want to update crash data and fill build number</div>
    <form action="getiOSData" method="POST">
      <div class="form-check col-sm-8 form-group">
        <input class="form-check-input col-sm-4" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="KijijiCA">
        <img src="../static/asset/fonts/icon_iOS/icon_CA.png" width="30" height="30" class="col-auto">
        <input class="form-check-input col-sm-8" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="GumtreeAU">
        <img src="../static/asset/fonts/icon_iOS/icon_AU.png" width="30" height="30" class="col-auto">
        <input class="form-check-input col-sm-8" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="GumtreeZA">
        <img src="../static/asset/fonts/icon_iOS/icon_ZA.png" width="30" height="30" class="col-auto">
        <input class="form-check-input  col-sm-8" type="radio" name="inlineRadioOptions" id="inlineRadio8" value="GumtreeUK">
        <img src="../static/asset/fonts/icon_iOS/icon_UK.png" width="30" height="30" class="col-auto">
        <input class="form-check-input  col-sm-8" type="radio" name="inlineRadioOptions" id="inlineRadio4" value="VivanunciosMX">
        <img src="../static/asset/fonts/icon_iOS/icon_MX.png" width="30" height="30" class="col-auto">
        <input class="form-check-input  col-sm-8" type="radio" name="inlineRadioOptions" id="inlineRadio5" value="KijijiIT">
        <img src="../static/asset/fonts/icon_iOS/icon_IT.png" width="30" height="30" class="col-auto">
        <input class="form-check-input  col-sm-8" type="radio" name="inlineRadioOptions" id="inlineRadio6" value="AlamaulaAR">
        <img src="../static/asset/fonts/icon_iOS/icon_AR.png" width="30" height="30" class="col-auto">
<!--         <input class="form-check-input  col-sm-8" type="radio" name="inlineRadioOptions" id="inlineRadio7" value="GumtreeIE">
        <img src="../static/asset/fonts/icon_iOS/icon_IE.png" width="30" height="30" class="col-auto" > 
        <input class="col-sm-4 form-group tooltip-viewport-bottom" type="text" placeholder="Build Number" name="Build_Number" title="Fill ipa build number you want to update CrashRate. e.g 14990" pattern="\d{5}|\d{5}\.\d{1}" id="input1">
